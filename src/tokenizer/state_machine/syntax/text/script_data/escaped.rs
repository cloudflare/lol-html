define_state_group!(script_data_escaped_states_group = {
    ...
    script_data_escaped_dash_dash_state {
        b'-' => ()
        b'<' => ( emit_chars; mark_tag_start; --> script_data_escaped_less_than_sign_state )
    ...
    script_data_escaped_less_than_sign_state {
        ...
        eof                       => ( emit_chars; emit_eof; )
        _                         => ( unmark_tag_start; emit_chars; reconsume in script_data_escaped_state )
    }
    ...
    script_data_escaped_end_tag_name_state {
        whitespace => (
            if is_appropriate_end_tag
                ...
                ( unmark_tag_start; emit_chars; reconsume in script_data_escaped_state )
        )
        ...
        eof   => ( emit_chars; emit_eof; )
        _     => ( emit_chars; reconsume in script_data_escaped_state )
    }
