define_state_group!(doctype_states_group = {
    ...
    doctype_state {
        ...
        eof        => ( create_doctype; set_force_quirks; emit_current_token; emit_eof; )
    ...
    doctype_name_state {
        ...
        eof        => ( finish_doctype_name; set_force_quirks; emit_current_token; emit_eof; )
        _          => ()
    }
    ...
    doctype_public_identifier_state <-- ( start_token_part; ) {
        ...
        eof           => ( finish_doctype_public_id; set_force_quirks; emit_current_token; emit_eof; )
        _             => ()
    }
    ...
    doctype_system_identifier_state <-- ( start_token_part; ) {
        ...
        eof           => ( finish_doctype_system_id; set_force_quirks; emit_current_token; emit_eof; )
        _             => ()
    }
    ...
    bogus_doctype_state {
        b'>' => ( emit_current_token; --> data_state )
        eof  => ( emit_current_token; emit_eof; )
        _    => ()
    }
